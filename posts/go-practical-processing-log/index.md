...
具体的解析可以参考 [Go 项目实战：搭建高效的 Gin Web 目录结构](https://vespeng.github.io/posts/go-practical-gin-directory-structure/#配置config)
...
> URL: https://vespeng.github.io/posts/go-practical-processing-log/  
